        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="sign-up-desktop-menu">
            <nav className="sign-up-links">
              <Link to="/" className="sign-up-home-link bodySmall">
                Home
              </Link>
              <Link to="/rooms" className="sign-up-room-link bodySmall">
                Rooms
              </Link>
          ...
          >
            <div className="sign-up-nav">
              ...
              <nav className="sign-up-links1">
                <span className="sign-up-nav12 bodySmall">Home</span>
                <span className="sign-up-nav22 bodySmall">Rooms</span>
                <span className="sign-up-nav32 bodySmall">Login</span>
