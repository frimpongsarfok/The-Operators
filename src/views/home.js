      ...
      <div className="home-hero">
        <div className="home-hero1 heroContainer">
          <div className="home-container1">
            <h1 className="home-hero-heading">Book Your Stay with Ease</h1>
            ...
            <div className="home-btn-group">
              <Link to="/rooms" className="home-room-linker buttonFilled">
                Explore Rooms
              </Link>
            </div>
          </div>
          ...
          <div className="home-features1">
            <div className="home-container2">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover the key features that make our motel reservation
                      site stand out
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container3">
              <FeatureCard
                ...
                subHeading="Simple and user-friendly interface for quick reservations"
              ></FeatureCard>
              <FeatureCard
                heading="Wide Selection of Rooms"
                subHeading="Choose from a variety of rooms to suit your needs and preferences"
              ></FeatureCard>
              <FeatureCard
                heading="Secure Payment Options"
                subHeading="Safe and secure payment methods to protect your information"
              ></FeatureCard>
              <FeatureCard
                heading="24/7 Customer Support"
                subHeading="Dedicated customer service team available round the clock for assistance"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container5">
              <Question1
                answer="To make a reservation, simply select your desired dates and room type on the room listing page, then proceed to checkout."
                question="How do I make a reservation?"
              ></Question1>
              <Question1
                answer="Yes, you can modify or cancel your reservation by logging into your account and accessing your booking details."
                question="Can I modify or cancel my reservation?"
              ></Question1>
              <Question1
                answer="We accept major credit cards such as Visa, Mastercard, and American Express for payment."
                question="What payment methods are accepted?"
              ></Question1>
              <Question1
                answer="Breakfast options vary by room type. You can check if breakfast is included in the room details before booking."
                question="Is breakfast included in the room rate?"
              ></Question1>
              <Question1
                answer="Yes, we offer discounts for group bookings. Please contact our customer service for more information on group rates."
